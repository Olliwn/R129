...
| Sub Enclosure Materials | 16mm MDF + polyfill + silicone + PVA D3 + 4×40 mm wood screws | — | Sealed 14L box for rear cubby. Buy pre-cut panels at Bauhaus' panel saw based on the Sunday cardboard mock-up dimensions. Polyfill sourced from Autoviihde (acoustic-grade "vaimennusvilla") or pillow-stuffing fallback from Sinelli / Tokmanni — same polyester fibre. ~€30 all-in. Build spec: `work/subwoofer_enclosure/README.md`. |
