...
***Routing correction (2026-05-05 late):** the original entry below claimed early M119.960 uses a separate V-belt for the A/C compressor in addition to the main poly-V. **This is wrong for engine 119.960 in chassis 129.066** — the official MB WIS belt-routing diagram (titled "Engine 119.960, model 129.066, Running diagram with air pump, Belt length 2523 mm, 6 grooves") shows a **single 6PK2523 serpentine** threading through all accessories including the A/C compressor (pulley #3). The two-belt assumption came from forum cross-references that conflated the M119.960 with earlier M117/M116 V8s and other M119 sub-variants. The WIS diagram is authoritative; forum archives are not. The `A 004 997 05 92` AVX13X950 V-belt was **ordered in error** and is not applicable to this car. See diary entry 2026-05-05 (late) for the correction trail.*

| Part | OEM Number | Qty | Posture | Notes |
| :--- | :--- | :--- | :--- | :--- |
| **Main Poly-V Serpentine Belt** (drives all accessories incl. A/C compressor — single belt) | **A 010 997 99 92** | 1 | **INSTALLED 2026-05-06** | **ContiTech 6PK2523** (51% off RRP, €32.49). Spec 6PK2523 (6 ribs × 2523 mm). Cross-listed as A 011 997 68 92 / A 119 997 01 92. Correct specifically for M119.960 *with catalytic converter* (AOK912 match). **WIS-confirmed 2026-05-05** as the only belt on this engine/chassis — single serpentine routing through tensioner, crankshaft, A/C compressor, bottom guide pulley, fan, air pump, alternator, power steering pump, coolant pump. Installed smoothly on 2026-05-06; belt squeal disappeared. Removed belt looked nearly new, so possible root cause includes weak tension/preload rather than belt condition alone. Old belt retained in the car as a clearly marked **used** emergency road-trip spare. Do NOT substitute the 6PK2510 (late M119.982 w/ A/C), 6PK2425 (M119.982 w/o A/C), 6PK2535 / 6PK2540 (M119.972) — all are different M119 variants with different accessory drive layouts. |
| ~~**A/C Compressor V-Belt** (separate classic V-belt) — ORDERED IN ERROR, not applicable to engine 119.960 in chassis 129.066~~ | ~~A 004 997 05 92~~ | ~~1~~ | **ARRIVED 2026-04-27, NOT FITTED — ordering error** | ~~ContiTech AVX13X950~~. **Correction logged 2026-05-05 (late):** WIS belt-routing diagram for engine 119.960 / chassis 129.066 shows a single 6PK2523 serpentine driving the A/C compressor directly — there is no separate A/C V-belt on this car. Visual inspection by the owner (single belt observed at the front of the engine) and multiple internet sources are consistent with the WIS diagram. The €10.49 part is kept on the shelf as a generic 12 × 960 V-belt spare; not worth Autodoc RMA round-trip. Lesson logged: pull the WIS belt diagram for the specific engine/chassis combo *before* ordering, not after — forum cross-references are not a substitute. |
...
1. ~~Confirm A 010 997 99 92 and A 004 997 05 92 by VIN → order both.~~ **Superseded 2026-05-05 (late):** A 010 997 99 92 already on hand and confirmed by WIS as the *only* belt for engine 119.960 in chassis 129.066. A 004 997 05 92 was an ordering error (no separate A/C V-belt on this car). No belt-side order needed from MB-osat.
2. Check stock on A 119 200 00 36 (tensioner rod) → order now if available, fallback to aftermarket if not.
3. Price-check but do NOT order the tensioner assembly (A 119 200 02 70), the two pulleys (A 119 200 14 70, A 119 200 04 70), and the aux pulley (A 601 200 09 70). Belt swap on 2026-05-06 resolved the squeal, but the removed belt looked nearly new, so tensioner/preload stays on the inspect-first list for the next front-access session.
...
4. Bump-stop kit splittable from MEYLE boots already on hand, or full Sachs kit only? **Posture LOCKED 2026-05-05 (late):** dust boots stay with MB-osat (see #5), so this question stands as originally posed — confirm whether MB-osat will use the on-hand MEYLE 014 032 0032 boots and only invoice the bump-stop portion of the Sachs kit, or whether the kit is not splittable.
5. MEYLE dust boots accepted as substitute parts by MB-osat? **Posture LOCKED 2026-05-05 (late):** **DIY rejected — boots stay with MB-osat.** Visual inspection confirmed the MEYLE 014 032 0032 is **one-piece slip-on** (not clamshell), which means the strut must come out and be disassembled on the bench with an ADS-rated spring compressor. Bargain spring compressors are not safe for the preloaded ADS spring rate, and the labour saved (~€207) does not justify either renting a rated compressor or absorbing the safety risk. MB-osat already needs to disturb the strut for the lower control arm work, so the boot install folds into their existing labour with minimal incremental charge. Question #5 reduces to "confirm MEYLE boots are accepted as the substitute part" — they will be.
